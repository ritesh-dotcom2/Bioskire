...
<div class="hero-section">
  <img src="images/banner/about-banner.png" alt="">
</div>
...
<!-- <div class="company">
  <div class="img">
    <div class="video">
      <video width="550" height="400" autoplay loop muted class="videonew">
        <source src="images/banner/IMG_2132.MP4" type="video/mp4">
  ...
  <div class="company-info">
    <p>
    <h2 class="newvision">Happy and Healthy with Nature Heals India </h2>
    In today's fast-paced urban lifestyle, more and more people are seeking natural products that offer purity and high
    quality. The demand for organic cosmetic products has seen a significant rise as people become conscious of what
    they put on their skin. In this movement towards embracing nature's goodness, Natural Heals has emerged as a leading
    brand dedicated to providing natural and healthy solutions for both personal care and healthcare needs.
    <br>
    <br>

    With a strong commitment to sourcing only the finest organic ingredients, we ensure that our customers receive the
    highest quality products without compromising on their health or the environment. Our extensive range of products
    spans from skincare essentials to herbal remedies, catering to diverse needs while adhering to strict standards of
    purity.
...
<div>
  <p class="newcontent">Whether you are finding the perfect moisturiser free from harmful chemicals or exploring body
    soup, or natural oil, Natural We are excited to invite you to join us as we pursue a lifestyle that is more in tune
    with nature and the enviroment. Our line of personal care products incorporates the powerful benefits of activated
    charcoal and other natural ingredients to provide you with an unparalleled expeience. At our company, we understand
    the importance of protecting our planet, which is why we make sure to prioritise eco-friendliness in every aspect of
    our product development and production processes.</p>
</div> -->
...
<div class="blog_grid_wrap blog_list_wrap pr">
  <div class="container">
    <h2 class="testimonial2_title text-center pb-4 " style="padding:30px;" data-aos="fade-up" data-aos-duration="3000">
      #SHINEANDGLOW BY BIOSKIRE</h2>
    <div class="row g-4" data-aos="fade-up" data-aos-duration="3000">
      <div class="col-sm-6 col-md-3">
        <div class="blog_grid_cont blog_list_cont bg-white">
          <div class="grid_img d-flex blog_list_img">
            <img src="images/banner/1.png" alt="image_not_found">
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-3">
        <div class="blog_grid_cont blog_list_cont bg-white">
          <div class="grid_img d-flex blog_list_img">
            <img src="images/banner/2.png" alt="image_not_found">
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-3">
        <div class="blog_grid_cont blog_list_cont bg-white">
          <div class="grid_img d-flex blog_list_img">
            <img src="images/banner/3.png" alt="image_not_found">
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-3">
        <div class="blog_grid_cont blog_list_cont bg-white">
          <div class="grid_img d-flex blog_list_img">
            <img src="images/banner/4.png" alt="image_not_found">
          </div>
        </div>
      </div>
    </div>
...
<!-- <div class="pa-counter spacer-top spacer-bottom pr">
  <div class="container" style="padding:40px;">
    <div class="pa-heading" data-aos="fade-up" data-aos-duration="3000">
      <h1>Benefit from choosing the best</h1>
      <h5>Our recent achievements</h5>
    </div>
    <div class="pa-counter-main" id="counter" data-aos="fade-up" data-aos-duration="3000" style="    margin-top: 25px;">
      <div class="row">
        <div class="col-lg-3 col-sm-6">
          <div class="pa-counter-box" data-aos="fade-up" data-aos-duration="3000">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 467.528 467.528">
              ...
              <g>
                <path d="M312.295,140.8c-2-2.8-4.4-4.8-7.2-6s-6-2-9.2-1.6h-33.2l-10.4-32.8c-1.6-4.8-5.2-8.8-9.2-11.2c-2.8-1.2-5.6-2-8.8-2
                                        ...
                                        C299.095,152.8,298.695,153.2,298.295,153.6z"></path>
              </g>
              <g>
                <path d="M327.895,76.4c-24-24-57.2-38.8-94-38.8s-70,14.8-94,38.8s-38.8,57.2-38.8,94s14.8,70,38.8,94s57.2,38.8,94,38.8
                                        ...
                                        S337.095,231.6,316.295,252.4z"></path>
              </g>
            </svg>
            <h1 class="counter-value" data-count="25">25</h1>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="pa-counter-box" data-aos="fade-up" data-aos-duration="3000">
            ...
            <h1 class="counter-value" data-count="50">50</h1><span> k+</span>
            <p>happy customers</p>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="pa-counter-box" data-aos="fade-up" data-aos-duration="3000">
            ...
            <h1 class="counter-value" data-count="800">800</h1><span> +</span>
            <p>products</p>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="pa-counter-box" data-aos="fade-up" data-aos-duration="3000">
            ...
            <h1 class="counter-value" data-count="100">100</h1><span> %</span>
            <p>Product purity</p>
          </div>
        </div>
      </div>
...
<div class="rts-secvice-area-solaric-banner-bottom start rts-section-gapBottom ptb--25 pr">
    <div class="container">
        <div class="section__title--2 text-center">
            <h2 class="title__line mb--30">Join BIOSKIRE</h2>
        </div>
        <div class="row g-24">
            <div class="col-lg-3 col-md-6 cols-md-12 col-12">
                <div class="single-solari-service-start">
                    <div class="icon-area">
                        <img src="images/brand/fast-del.gif" alt="">
                    </div>

                    <h5 class="title">Fast and Reliable Delivery</h5>

                    <p class="disc">
                    Say goodbye to long wait times.Enjoy fast and reliable shipping on all orders, so you can start experiencing the benefits of our premium skincare products sooner.
                    </p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 cols-md-12 col-12">
                <div class="single-solari-service-start two">
                    <div class="icon-area">
                        <img src="images/brand/pay.gif" alt="">
                    </div>

                    <h5 class="title">Secure Payment Options</h5>

                    <p class="disc">
                    Shop with confidence knowing that your transactions are secure. Either you want COD or you want to pay with UPI, we have you covered.
                    </p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 cols-md-12 col-12">
                <div class="single-solari-service-start three">
                    <div class="icon-area">
                        <img src="images/brand/shop.gif" alt="">
                    </div>

                    <h5 class="title">Close Shopping Experience</h5>

                    <p class="disc">
                    Shop with ease from the comfort of your home. Our user-friendly website make it simple to buy your favorite skincare products with just a few clicks.
                    </p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 cols-md-12 col-12">
                <div class="single-solari-service-start four">
                    <div class="icon-area">
                        <img src="images/brand/customer.gif" alt="">
                    </div>

                    <h5 class="title">Exceptional Customer Service</h5>

                    <p class="disc">
                    Have questions or need assistance? Our dedicated customer service team is here to help. Contact us via phone, email, or live chat for prompt and friendly support.
                    </p>
                </div>
            </div>
        </div>
...
<!-- <div class="mob-hero">
    <img src="images/banner/IMG_2093.PNG" alt="">
</div>
<div class="top-ab mt--30 mb--30">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 top-ab-img">
                <img src="images/banner/inject.jpg" alt="">
            </div>
            <div class="col-lg-6 top-ab-cont mt--30 mb--30">
                <div class="col-lg-6 top-ab-cont1">
                    <h5>Our Commitment</h5>
                    <p>With a strong foundation of ethics, integrity, and innovation, Cedar Medicare is dedicated to offering a wide range of pharmaceutical products that adhere to the highest standards of quality and safety. Our team of experienced professionals works tirelessly to ensure that every product that reaches you is backed by rigorous research, stringent quality control, and regulatory compliance.</p>
                </div>
                <div class="col-lg-6 top-ab-cont2">
                    <h5>Our Mission</h5>
                    <p>Cedar Medicare’s mission is to make a positive impact on the lives of the people of Maharashtra by ensuring access to high-quality and affordable medicines. We aim to enhance the health and happiness of our community through comprehensive healthcare solutions, cutting-edge pharmaceuticals, and a patient-centric approach.</p>
                </div> 
                <div class="col-lg-12 top-ab-cont3">
                <h5>Our Vision</h5>
                    <p>Our Vision is to emerge as a leading pharmaceutical company by making available quality pharmaceutical products at affordable costs to all.</p>
                </div>
            </div>
        </div>
    </div>
