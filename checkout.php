					...
					<div class="accordion-list">
						<div class="accordion">
											...
											<div class="col-md-6">
												<div class="checkout-method__login">
													<form id="login-form" method="post">
														...
														<div class="dark-btn">
															<button type="button" class="fv-btn2"
							...
							<form method="post">
								...
								<div class="accordion__body">
									<div class="paymentinfo">
										<div class="single-method">
											...
											&nbsp;&nbsp;Instamojo <input type="radio" name="payment_type"
												value="instamojo" required />
										</div>
										<div class="single-method">
								...
								<input type="submit" name="submit" class="fv-btn2" />
							</form>
						</div>
					</div>
				</div>
			...
			<div class="col-md-4">
				<div class="order-details">
					...
					<!-- <div class="ordre-details__total bilinfo">
								<input type="textbox" id="coupon_str" class="coupon_style mr5"/> <input type="button" name="submit" class="fv-btn2 coupon_style" value="Apply Coupon" onclick="set_coupon()"/>
