...
?>
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/banner/IMG_2157.PNG) no-repeat scroll center center / cover ;">
...
<div class="mob-hero">
    <img src="images/banner/profile-m.png" alt="">
</div>
        <!-- End Bradcaump area -->
        <!-- cart-main-area start -->
<div class="wishlist-area ptb--60 bg__white">
    <div class="container">
        <div class="row">
