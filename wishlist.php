...
<div class="ht__bradcaump__area"
    style="background: rgba(0, 0, 0, 0) url(images/banner/IMG_2096.PNG) no-repeat scroll center center / cover ;">
...
<div class="mob-hero">
    <img src="images/banner/wish.png" alt="">
</div>
<!-- End Bradcaump area -->
                                ...
                                while ($row = mysqli_fetch_assoc($res)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-remove"><a href="javascript:void(0)"
                                                onclick="manage_cart('<?php echo $row['pid'] ?>','add')">Add to Cart</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
